...
insert into userinfo(username,password,isadmin) values('唐僧','123',0);
insert into userinfo(username,password,isadmin) values('八戒','123',0);
insert into userinfo(username,password,isadmin) values('悟空','123',0);
insert into dish(name,price) values('拍黄瓜','10');
